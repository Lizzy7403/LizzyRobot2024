...
public class RotateIntakeCommandWithPID extends Command {
    ...
    public RotateIntakeCommandWithPID(Intake intake, double setpoint, boolean isExtended, double kP, double kI, double kD, double kIz, double kFF) {
        this.intake = intake;

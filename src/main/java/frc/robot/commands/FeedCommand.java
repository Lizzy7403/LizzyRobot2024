...
public class FeedCommand extends Command {
    ...
    public FeedCommand(Intake intake, double speed) {
        this.intake = intake;
        this.speed = speed;
    ...
    public void initialize() {
        if(Math.abs(speed) > Constants.IntakeConstants.kMaxAbsOutputRBRetracted) {
            intake.spinIntake(speed);
        }
        intake.spinIntake(Constants.IntakeConstants.kMaxAbsOutputRBRetracted);
    }
